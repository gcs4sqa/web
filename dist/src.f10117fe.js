...
/** @class */
function () {
  function ApiSync(rootUtl) {
    this.rootUtl = rootUtl;
  }

  ;

  ApiSync.prototype.fetch = function (id) {
    return axios_1.default.get(this.rootUtl + "/" + id);
  };
  ...
  ApiSync.prototype.save = function (data) {
    ...
    if (id) {
      // put
      return axios_1.default.put(this.rootUtl + "/" + id, data);
    } else {
      // post
      return axios_1.default.post(this.rootUtl + "/", data);
    }
  };
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || []; //can be a callback ir undefined
...
exports.User = User; //this is temp code
